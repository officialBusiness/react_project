...
## 小结
&emsp;简单的讲解了一下负责的部分功能，项目代码还是处于一个应用的层次，个人是感觉还是有很多需要弥补的地方的，比如说三维模型的渲染问题（我记得在网上找到一个一次渲染概念来解决这个问题）、地图的渲染问题、窗口切换的延迟问题等……不过嘛，公司突然搬了，撑了一个月，这个作息感觉人快要挂掉了，就只能辞职了，想想也有点小遗憾啊
